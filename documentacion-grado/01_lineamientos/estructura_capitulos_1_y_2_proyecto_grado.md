...
2. **Capítulo I — Marco introductorio**: presenta el caso, los antecedentes institucionales y trabajos similares, el problema, los objetivos, la justificación, el alcance y el diseño metodológico.
3. **Capítulo II — Marco teórico y conceptual**: desarrolla únicamente los conceptos y relaciones necesarios para comprender, diseñar y evaluar la solución de trazabilidad.
4. **Capítulo III — Marco aplicativo**: desarrollará posteriormente el análisis, diseño, construcción e integración de la solución; su estructura interna todavía debe definirse.
...
El cuarto precedente resulta especialmente cercano a la organización adoptada para R3Foresta: coloca en el Capítulo I los antecedentes institucionales y de trabajos anteriores, seguidos del problema, los objetivos, las justificaciones, los límites y alcances y el diseño metodológico. No obstante, su índice contiene inconsistencias de numeración y desarrolla en el Capítulo II contenidos metodológicos y tecnológicos que no deben copiarse automáticamente. La referencia sirve para confirmar la ubicación general de las secciones, no como modelo de calidad o contenido.
...
La decisión confirmada conserva la introducción como sección independiente, reorganiza los aspectos generales dentro del Capítulo I y desplaza el marco teórico al Capítulo II. El diseño metodológico se incluye dentro del Capítulo I y no tendrá un capítulo independiente. El Capítulo III se denominará Marco aplicativo. Estos ajustes son editoriales y deben conservar el problema, los objetivos y el alcance; cualquier cambio sustantivo continuará sujeto a revisión.

## 4. Criterios de redacción para ambos capítulos

- El capítulo I debe partir del Perfil, pero actualizarse con evidencia obtenida durante el diagnóstico. No debe copiarse mecánicamente como si todavía fuera una propuesta.
...
Decisiones confirmadas por el postulante el 24 de agosto de 2026:
...
- diseño metodológico dentro del Capítulo I, sin capítulo metodológico independiente;
- Capítulo II denominado Marco teórico y conceptual;
- Capítulo III denominado Marco aplicativo, con detalle pendiente.
...
3. la denominación y estructura de los capítulos posteriores al Marco aplicativo;
4. el formato final de fuente, interlineado, márgenes, empaste y entrega digital.
