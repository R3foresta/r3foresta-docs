...
| `ADR-PLA-01` | [`02_decisiones_plantacion.md`](02_decisiones_plantacion.md) | Decisiones cerradas del módulo Plantación (edición básica y desactivación de campaña en MVP). |
